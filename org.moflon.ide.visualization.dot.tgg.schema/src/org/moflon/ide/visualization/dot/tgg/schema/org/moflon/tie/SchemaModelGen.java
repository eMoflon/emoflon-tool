package org.moflon.ide.visualization.dot.tgg.schema.org.moflon.tie;
...
public class SchemaModelGen extends SynchronizationHelper{

   public SchemaModelGen()
   {
	...
	public static void main(String[] args) throws IOException {
		...
		ModelGenerator gen = new ModelGenerator(SchemaPackage.eINSTANCE, controller);
		gen.generate();
	}
}