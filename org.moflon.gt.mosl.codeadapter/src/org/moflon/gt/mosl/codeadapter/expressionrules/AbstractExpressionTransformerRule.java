...
public abstract class AbstractExpressionTransformerRule<A extends AbstractAttribute, E extends Expression> implements IAbstractAttributeClassGetter<A>, IExpressionTransformationRule
{
   ...
   protected abstract ValidationReport transform(ObjectVariablePattern ov, E expr, PatternBody patternBody);
   ...
   @Override
   public ValidationReport invoke(final ObjectVariablePattern ov, final AbstractAttribute abstractAttribute, final PatternBody patternBody)
   {
      return castAndInvokeExpression(ov, abstractAttribute.getValueExp(), patternBody);
   }

   private ValidationReport castAndInvokeExpression(final ObjectVariablePattern objectVariable, final Expression expression, final PatternBody patternBody)
   {
