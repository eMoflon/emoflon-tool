package org.moflon.ide.visualization.dot.sdm.org.moflon.tie;
...
public class SdmConsistencyCheck extends SynchronizationHelper{

   public SdmConsistencyCheck()
   {
      super(SdmPackage.eINSTANCE, ".");
   }
	public static void main(String[] args) throws IOException {
		// Set up logging
        BasicConfigurator.configure();
        
        SdmConsistencyCheck helper = new SdmConsistencyCheck();
