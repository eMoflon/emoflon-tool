 ...
 * isAppropriate input match can be extended to a full match over all domains.
 * 
 * @author anjorin
 *
 */
public class InvokeIsApplicable implements Function<Match, IsApplicableRuleResult>
{
   ...
   public IsApplicableRuleResult apply(Match match)
   {
      ...
      IsApplicableRuleResult isApplRR = (IsApplicableRuleResult) InvokeUtil.invokeOperationWithSingleArg(isAppl.getEContainingClass(), isAppl, match);
