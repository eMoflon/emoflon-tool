...
public class ModelGenerator
{
   ...
   public ModelGenerator(final EPackage tggPackage, final AbstractModelGenerationController abstractTGGModelGenController, final boolean persistModels, final boolean writeLog)
   {
      ...
      {
         logger.warn("The corresponding tgg model file (" + tggPackage.getName() + ".tgg.xmi) cannot be found - model size statistics can not be collected");
      }

   }

   public ModelGenerator(final EPackage tggPackage, final AbstractModelGenerationController abstractTGGModelGenController)
   {
   ...
   public GenerationResult generate()
   {
      ...
      while (controller.continueGeneration(lastResult, dataContainer.getModelgenStats()))
      {
         ...
         EOperation genModelOperation = controller.getNextTggRule(rulesToBeApplied, dataContainer.getModelgenStats());
         ...
         {
            dataContainer.getModelgenStats().addFailure(genModelOperation.getEContainingClass().getName(), duration);
         }
      }
