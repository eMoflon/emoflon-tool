...
public interface Configurator
{
   ...
   /**
    * Return true to activate an additional heuristic used to resolve possible conflicts (matches that can translate the
    * same element). As this can be quite costly and is not always required the default is false.
    */
   ...
   /**
    * Allows for user-defined optimizations on the precedence graph before translation starts. This can be used to
