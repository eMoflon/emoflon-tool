...
public class SdmpatternsConsistencyCheck extends SynchronizationHelper{

   public SdmpatternsConsistencyCheck()
   {
	...
	public static void main(String[] args) throws IOException {
        ...
        SdmpatternsConsistencyCheck helper = new SdmpatternsConsistencyCheck();
