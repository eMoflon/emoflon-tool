...
public class SdmpatternsTrafo extends SynchronizationHelper{

   public SdmpatternsTrafo()
   {
	...
	public static void main(String[] args) throws IOException {
        ...
        SdmpatternsTrafo helper = new SdmpatternsTrafo();
		helper.performForward("instances/fwd.src.xmi");
		
		// Backward Transformation
		helper = new SdmpatternsTrafo();
