...
/**
 * Project dependency analysis should be carried out on a locked workspace in a separate thread to avoid inconsistency in the build configuration caused by the analysis process
 *
 */
