...
public class CodeAnalyzerUtil
{
    ...
    */
   public static List<JavaCodeRule<TypeElement>> getRuleInstances(final Set<String> ruleNameList)
   {
    ...
    */
   public static String getSimpleNameFromQualifiedName(final String qualifiedName)
   {
   ...
   public static List<String> getAnnotationAsStringList(final ClassFile classFile)
   {
