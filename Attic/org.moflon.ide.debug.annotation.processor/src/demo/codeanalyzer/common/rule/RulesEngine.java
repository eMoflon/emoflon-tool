...
/**
 * RulesEngine encapsulates the details of Rules used for verificaion. This class load the rules defined in
 * <i>rules.xml</i> file and then invokes the appropriate rule class for executing these rules.
 * 
...
public class RulesEngine
{
   ...
   /**
    * Method to get the details of rules used for verification and to invoke the appropriate rule class to execute these
    * rules.
    * 
    * @param javaClass
    ...
    * 
    * @param ctx
    *           The ProblemContext containing the module-name and classtype details
   ...
   /**
    * Retrieves the details of problems identified in the source file after executing the rules
    * 
