...
import org.moflon.tutorial.sokobangamegui.actions.LoadSaveTextAction;
...
public class View extends JFrame {
	...
	private void initializeComponents() {
		...
		JMenuItem loadText = new JMenuItem("Load Text instance ...");
		JMenuItem saveText = new JMenuItem("Save Text instance ...");
		
		/* Create their action listeners */
		ActionListener loadSaveAction = new LoadSaveAction(this, saveItem, loadItem);
		ActionListener loadSaveTextAction = new LoadSaveTextAction(this, saveText, loadText);
		...
		loadText.addActionListener(loadSaveTextAction);
		saveText.addActionListener(loadSaveTextAction);
