...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Admin Node To Figure Rule</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * </p>
 *
 * @generated
 */
public class AdminNodeToFigureRuleImpl extends AbstractRuleImpl implements
		AdminNodeToFigureRule {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected AdminNodeToFigureRuleImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return RulesPackage.Literals.ADMIN_NODE_TO_FIGURE_RULE;
	}
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Edge floor__figure__admin = null;
		...
		try {
			...
			// create object admin
			admin = SokobanLanguageFactory.eINSTANCE.createAdmin();

			// create link
			admin.setFloor(floor);
		...
		try {
			...
			// check object admin is really bound
			JavaSDM.ensure(admin != null);
		...
		try {
			...
			// check isomorphic binding between objects figureNode and admin 
			JavaSDM.ensure(!figureNode.equals(admin));

			// check isomorphic binding between objects floor and admin 
			JavaSDM.ensure(!floor.equals(admin));

			// check isomorphic binding between objects floorNode and admin 
			JavaSDM.ensure(!floorNode.equals(admin));

			// check isomorphic binding between objects nodeToFloor and admin 
			JavaSDM.ensure(!nodeToFloor.equals(admin));
			...
			// create object floor__figure__admin
			floor__figure__admin = TGGRuntimeFactory.eINSTANCE.createEdge();
			...
			// assign attribute floor__figure__admin
			floor__figure__admin.setName("figure");

			// create link
			org.moflon.core.utilities.eMoflonEMFUtil.addOppositeReference(ruleresult,
					floor__figure__admin, "createdEdges");
			...
			// create link
			floor__figure__admin.setSrc(floor);

			// create link
			floor__figure__admin.setTrg(admin);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		try {
			...
			// assign attribute ruleresult
			ruleresult.setRule("AdminNodeToFigureRule");
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		try {
			...
			_TmpObject = (isApplicableMatch.getObject("admin"));

			// ensure correct type and really bound of object admin
			JavaSDM.ensure(_TmpObject instanceof Admin);
			admin = (Admin) _TmpObject;
			_TmpObject = (isApplicableMatch.getObject("floor"));
		...
		try {
			...
			// create link
			org.moflon.core.utilities.eMoflonEMFUtil.addOppositeReference(ruleresult,
					floor__figure__admin, "translatedEdges");
	 ...
	 * @generated
	 */
	public boolean isAppropriate_BWD(Match match, Floor floor, Admin admin) {
		boolean fujaba__Success = false;
		Edge floor__figure__admin = null;
		...
		if (fujaba__Success) {
			...
			try {
				...
				// create link
				org.moflon.core.utilities.eMoflonEMFUtil.addOppositeReference(match,
						floor__figure__admin, "toBeTranslatedEdges");

				// create link
				org.moflon.core.utilities.eMoflonEMFUtil.addOppositeReference(match,
						admin, "toBeTranslatedElements");
				...
				// create link
				org.moflon.core.utilities.eMoflonEMFUtil.addOppositeReference(
						floor__figure__admin, floor, "src");
				fujaba__Success = true;
			} catch (JavaSDMException fujaba__InternalException) {
				fujaba__Success = false;
			}
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		try {
			...
			_TmpObject = (match.getObject("admin"));
		...
		try {
			...
			// check object floor is really bound
			JavaSDM.ensure(floor != null);
			// check link figure from floor to admin
			JavaSDM.ensure(admin.equals(floor.getFigure()));
	 ...
	 * @generated
	 */
	public IsAppropriateRuleResult isAppropriate_FWD_Node_0(Node floorNode) {
		boolean fujaba__Success = false;
		Object _TmpObject = null;
	 ...
	 * @generated
	 */
	public IsAppropriateRuleResult isAppropriate_FWD_Node_1(Node figureNode) {
		boolean fujaba__Success = false;
		Object _TmpObject = null;
		EClass __eClass = null;
		Iterator fujaba__Iter__eClassTo__performOperation = null;
	 ...
	 * @generated
	 */
	public IsAppropriateRuleResult isAppropriate_BWD_Floor_0(Floor floor) {
		boolean fujaba__Success = false;
		Object _TmpObject = null;
		EClass __eClass = null;
		Iterator fujaba__Iter__eClassTo__performOperation = null;
		...
		try {
			...
			try {
				...
				// statement node 'bookkeeping with generic isAppropriate method'
				fujaba__Success = this.isAppropriate_BWD(match, floor, admin);
				if (fujaba__Success) {
					// story node 'Add match to rule result'
					try {
						fujaba__Success = false;
	 ...
	 * @generated
	 */
	public IsAppropriateRuleResult isAppropriate_BWD_Admin_0(Admin admin) {
		boolean fujaba__Success = false;
		Object _TmpObject = null;
		EClass __eClass = null;
		Iterator fujaba__Iter__eClassTo__performOperation = null;
	...
	public Object eInvoke(int operationID, EList<?> arguments)
		...
		switch (operationID) {
		case RulesPackage.ADMIN_NODE_TO_FIGURE_RULE___IS_APPROPRIATE_FWD__MATCH_NODE_NODE:
			return isAppropriate_FWD((Match) arguments.get(0),
					(Node) arguments.get(1), (Node) arguments.get(2));
		case RulesPackage.ADMIN_NODE_TO_FIGURE_RULE___PERFORM_FWD__ISAPPLICABLEMATCH:
			return perform_FWD((IsApplicableMatch) arguments.get(0));
		case RulesPackage.ADMIN_NODE_TO_FIGURE_RULE___IS_APPLICABLE_FWD__MATCH:
			return isApplicable_FWD((Match) arguments.get(0));
		case RulesPackage.ADMIN_NODE_TO_FIGURE_RULE___IS_APPROPRIATE_BWD__MATCH_FLOOR_ADMIN:
			return isAppropriate_BWD((Match) arguments.get(0),
					(Floor) arguments.get(1), (Admin) arguments.get(2));
		case RulesPackage.ADMIN_NODE_TO_FIGURE_RULE___PERFORM_BWD__ISAPPLICABLEMATCH:
			return perform_BWD((IsApplicableMatch) arguments.get(0));
		case RulesPackage.ADMIN_NODE_TO_FIGURE_RULE___IS_APPLICABLE_BWD__MATCH:
			return isApplicable_BWD((Match) arguments.get(0));
		case RulesPackage.ADMIN_NODE_TO_FIGURE_RULE___IS_APPROPRIATE_FWD_NODE_0__NODE:
			return isAppropriate_FWD_Node_0((Node) arguments.get(0));
		case RulesPackage.ADMIN_NODE_TO_FIGURE_RULE___IS_APPROPRIATE_FWD_NODE_1__NODE:
			return isAppropriate_FWD_Node_1((Node) arguments.get(0));
		case RulesPackage.ADMIN_NODE_TO_FIGURE_RULE___IS_APPROPRIATE_BWD_FLOOR_0__FLOOR:
			return isAppropriate_BWD_Floor_0((Floor) arguments.get(0));
		case RulesPackage.ADMIN_NODE_TO_FIGURE_RULE___IS_APPROPRIATE_BWD_ADMIN_0__ADMIN:
			return isAppropriate_BWD_Admin_0((Admin) arguments.get(0));
		}
		return super.eInvoke(operationID, arguments);
	}

} //AdminNodeToFigureRuleImpl
