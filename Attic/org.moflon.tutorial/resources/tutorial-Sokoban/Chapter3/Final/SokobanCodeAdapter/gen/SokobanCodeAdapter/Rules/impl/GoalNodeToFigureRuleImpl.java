...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Goal Node To Figure Rule</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * </p>
 *
 * @generated
 */
public class GoalNodeToFigureRuleImpl extends AbstractRuleImpl implements
		GoalNodeToFigureRule {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected GoalNodeToFigureRuleImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return RulesPackage.Literals.GOAL_NODE_TO_FIGURE_RULE;
	}
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		try {
			...
			// create object goal
			goal = SokobanLanguageFactory.eINSTANCE.createGoal();
		...
		try {
			...
			// check object goal is really bound
			JavaSDM.ensure(goal != null);
		...
		try {
			...
			// check isomorphic binding between objects goal and figureNode 
			JavaSDM.ensure(!goal.equals(figureNode));
			...
			// check isomorphic binding between objects goal and floor 
			JavaSDM.ensure(!goal.equals(floor));

			// check isomorphic binding between objects nodeToFloor and floor 
			JavaSDM.ensure(!nodeToFloor.equals(floor));

			// check isomorphic binding between objects goal and floorNode 
			JavaSDM.ensure(!goal.equals(floorNode));

			// check isomorphic binding between objects nodeToFloor and floorNode 
			JavaSDM.ensure(!nodeToFloor.equals(floorNode));

			// check isomorphic binding between objects nodeToFloor and goal 
			JavaSDM.ensure(!nodeToFloor.equals(goal));

			// create object floor__figure__goal
			floor__figure__goal = TGGRuntimeFactory.eINSTANCE.createEdge();
			...
			// assign attribute floor__figure__goal
			floor__figure__goal.setName("figure");

			// create link
			org.moflon.core.utilities.eMoflonEMFUtil.addOppositeReference(ruleresult,
					floor__figure__goal, "createdEdges");
			...
			// create link
			floor__figure__goal.setSrc(floor);

			// create link
			floor__figure__goal.setTrg(goal);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		try {
			...
			// assign attribute ruleresult
			ruleresult.setRule("GoalNodeToFigureRule");
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		try {
			...
			JavaSDM.ensure(_TmpObject instanceof Node);
			floorNode = (Node) _TmpObject;
			_TmpObject = (isApplicableMatch.getObject("goal"));

			// ensure correct type and really bound of object goal
			JavaSDM.ensure(_TmpObject instanceof Goal);
			goal = (Goal) _TmpObject;
			_TmpObject = (isApplicableMatch.getObject("nodeToFloor"));
		...
		try {
			...
			// create link
			org.moflon.core.utilities.eMoflonEMFUtil.addOppositeReference(ruleresult,
					floor__figure__goal, "translatedEdges");
	 ...
	 * @generated
	 */
	public boolean isAppropriate_BWD(Match match, Floor floor, Goal goal) {
		boolean fujaba__Success = false;
		Edge floor__figure__goal = null;
		...
		if (fujaba__Success) {
			...
			try {
				...
				// create link
				org.moflon.core.utilities.eMoflonEMFUtil.addOppositeReference(match,
						goal, "toBeTranslatedElements");

				// create link
				org.moflon.core.utilities.eMoflonEMFUtil.addOppositeReference(match,
						floor__figure__goal, "toBeTranslatedEdges");
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		try {
			...
			JavaSDM.ensure(_TmpObject instanceof Floor);
			floor = (Floor) _TmpObject;
			_TmpObject = (match.getObject("goal"));
		...
		try {
			...
			// check object goal is really bound
			JavaSDM.ensure(goal != null);
			// check link figure from floor to goal
			JavaSDM.ensure(goal.equals(floor.getFigure()));
	 ...
	 * @generated
	 */
	public IsAppropriateRuleResult isAppropriate_FWD_Node_14(Node floorNode) {
		boolean fujaba__Success = false;
		Object _TmpObject = null;
	 ...
	 * @generated
	 */
	public IsAppropriateRuleResult isAppropriate_FWD_Node_15(Node figureNode) {
		boolean fujaba__Success = false;
		Object _TmpObject = null;
		EClass __eClass = null;
		Iterator fujaba__Iter__eClassTo__performOperation = null;
	 ...
	 * @generated
	 */
	public IsAppropriateRuleResult isAppropriate_BWD_Floor_5(Floor floor) {
		boolean fujaba__Success = false;
		Object _TmpObject = null;
		EClass __eClass = null;
		Iterator fujaba__Iter__eClassTo__performOperation = null;
		...
		try {
			...
			try {
				...
				// statement node 'bookkeeping with generic isAppropriate method'
				fujaba__Success = this.isAppropriate_BWD(match, floor, goal);
				if (fujaba__Success) {
					// story node 'Add match to rule result'
					try {
						fujaba__Success = false;
	 ...
	 * @generated
	 */
	public IsAppropriateRuleResult isAppropriate_BWD_Goal_0(Goal goal) {
		boolean fujaba__Success = false;
		Object _TmpObject = null;
		EClass __eClass = null;
		Iterator fujaba__Iter__eClassTo__performOperation = null;
	...
	public Object eInvoke(int operationID, EList<?> arguments)
		...
		switch (operationID) {
		case RulesPackage.GOAL_NODE_TO_FIGURE_RULE___IS_APPROPRIATE_FWD__MATCH_NODE_NODE:
			return isAppropriate_FWD((Match) arguments.get(0),
					(Node) arguments.get(1), (Node) arguments.get(2));
		case RulesPackage.GOAL_NODE_TO_FIGURE_RULE___PERFORM_FWD__ISAPPLICABLEMATCH:
			return perform_FWD((IsApplicableMatch) arguments.get(0));
		case RulesPackage.GOAL_NODE_TO_FIGURE_RULE___IS_APPLICABLE_FWD__MATCH:
			return isApplicable_FWD((Match) arguments.get(0));
		case RulesPackage.GOAL_NODE_TO_FIGURE_RULE___IS_APPROPRIATE_BWD__MATCH_FLOOR_GOAL:
			return isAppropriate_BWD((Match) arguments.get(0),
					(Floor) arguments.get(1), (Goal) arguments.get(2));
		case RulesPackage.GOAL_NODE_TO_FIGURE_RULE___PERFORM_BWD__ISAPPLICABLEMATCH:
			return perform_BWD((IsApplicableMatch) arguments.get(0));
		case RulesPackage.GOAL_NODE_TO_FIGURE_RULE___IS_APPLICABLE_BWD__MATCH:
			return isApplicable_BWD((Match) arguments.get(0));
		case RulesPackage.GOAL_NODE_TO_FIGURE_RULE___IS_APPROPRIATE_FWD_NODE_14__NODE:
			return isAppropriate_FWD_Node_14((Node) arguments.get(0));
		case RulesPackage.GOAL_NODE_TO_FIGURE_RULE___IS_APPROPRIATE_FWD_NODE_15__NODE:
			return isAppropriate_FWD_Node_15((Node) arguments.get(0));
		case RulesPackage.GOAL_NODE_TO_FIGURE_RULE___IS_APPROPRIATE_BWD_FLOOR_5__FLOOR:
			return isAppropriate_BWD_Floor_5((Floor) arguments.get(0));
		case RulesPackage.GOAL_NODE_TO_FIGURE_RULE___IS_APPROPRIATE_BWD_GOAL_0__GOAL:
			return isAppropriate_BWD_Goal_0((Goal) arguments.get(0));
		}
		return super.eInvoke(operationID, arguments);
	}

} //GoalNodeToFigureRuleImpl
