...
public class SokUnparserAdapter extends TemplateUnparserImpl 
{
  ...
  {
	  /* ../Chapter3/Final/SokobanCodeAdapter/templates/Sok.stg*/	  	  
	  File templateFile = new File(".." + File.separator + "Chapter3" + File.separator + 
			  "Final" + File.separator + "SokobanCodeAdapter" + File.separator + 
			  "templates" + File.separator + "Sok.stg");
