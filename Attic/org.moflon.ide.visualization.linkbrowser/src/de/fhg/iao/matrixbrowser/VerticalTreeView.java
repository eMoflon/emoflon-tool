 ...
 * VerticalTreeView.java,v 1.2 2004/04/07 13:52:32 roehrijn Exp $ Created on
 * 15.03.02
 */
package de.fhg.iao.matrixbrowser;

/**
 * Interface for a vertical <code>TreeView</code>.
 * 
 * @author <a href=mailto:christoph.kunz@iao.fraunhofer.de>Christoph Kunz </a>
 * @version $Revision: 1.1 $
 */
public interface VerticalTreeView extends TreeView {
}