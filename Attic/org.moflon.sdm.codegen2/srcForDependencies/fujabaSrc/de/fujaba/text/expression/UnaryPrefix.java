...
/**
 * UMLTextParser representation of a unary prefix operator like '!', '+' or '-'.
 * 
 * @author patrick.oppermann@cs.uni-kassel.de
 */
public class UnaryPrefix extends TextNode
{
   /**
    * 
    * @param parsedElement
    * @param prefixType
    */
   public UnaryPrefix(FParsedElement parsedElement, UnaryPrefixType prefixType)
   {
      super(parsedElement);
   ...
   /**
    * The kind of unary prefix this object represents.
    */
   private UnaryPrefixType prefixType;

   public void setPrefixType(UnaryPrefixType value)
   {
      this.prefixType = value;
   }

   public UnaryPrefixType getPrefixType()
   {
