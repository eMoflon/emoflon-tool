 ...
 */
public class TypeDereference extends TextNode
{
   public TypeDereference(FParsedElement parsedElement, Identifier identifier, TextNode childElement)
   {
      super(parsedElement);
   ...
   public boolean setIdentifier(Identifier value)
   {
