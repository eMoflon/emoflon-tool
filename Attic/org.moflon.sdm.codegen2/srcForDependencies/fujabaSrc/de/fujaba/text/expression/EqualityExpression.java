...
public class EqualityExpression extends BooleanOperation
{
    ...
    * @param operand2
    */
   public EqualityExpression(FParsedElement parsedElement, TextNode operand1, Operator operator, TextNode operand2)
   {
      super(parsedElement);
      setFirstOperand(operand1);
      addToOperatorOperandPairs(new OperatorOperandPair(parsedElement, operator, operand2));
   }
