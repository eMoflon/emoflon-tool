...
/**
 * note: Literal implements removeYou(), declaring it as final. This
 * way it is ensured that all subclasses fire the event REMOVE_YOU_STARTED
 * before anything is done.
 * 
 * @author patrick.oppermann@cs.uni-kassel.de
 */
public abstract class Literal extends ImageNode
{
   /**
    * 
    * @param parsedElement 
    ...
    * @param image
    */
   public Literal(FParsedElement parsedElement, LiteralType literalType, String image)
   {
      super(parsedElement);
      setImage(image);
   ...
   /**
    * Set the type of this literal.
    * @param literalType the new type of this literal.
    */
