...
public class ReturnStatement extends StatementNode
{
    ...
    * @param parsedElement
    */
   public ReturnStatement(FParsedElement parsedElement)
   {
      super(parsedElement);
   }
   ...
   public boolean setValue(TextNode value)
   {
      ...
      if(this.value != value)
      {
         final TextNode oldValue = this.value;
         this.value = value;
         ...
         {
            throw new IllegalStateException("return statement has invalid number of children: " + this.sizeOfChildren());
         }
