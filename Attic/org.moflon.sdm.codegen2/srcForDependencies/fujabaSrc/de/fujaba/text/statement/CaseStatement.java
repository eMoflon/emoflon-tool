 ...
 */
public class CaseStatement extends CaseOrDefaultStatement
{
    ...
    * @param parsedElement
    */
   public CaseStatement(FParsedElement parsedElement)
   {
      super(parsedElement);
   }
   ...
   public boolean setLiteral(Literal value)
   {
      boolean changed = false;

      if(this.literal != value)
      {
         final TextNode oldValue = this.literal;
         this.literal = value;
