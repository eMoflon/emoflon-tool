...
public abstract class CaseOrDefaultStatement extends StatementNode
{
    ...
    * @param parsedElement
    */
   public CaseOrDefaultStatement(FParsedElement parsedElement)
   {
      super(parsedElement);
   }
   ...
   public boolean setStatements(SequenceNode value)
   {
      boolean changed = false;

      if(this.statements != value)
      {
         final TextNode oldValue = this.statements;
