...
/**
 * Represents a break statement that can optionally
 * have a target label.
 * 
...
public class BreakStatement extends StatementNode
{
    ...
    * @param parsedElement
    */
   public BreakStatement(FParsedElement parsedElement)
   {
      super(parsedElement);
   }

   /**
    * Denotes the label to jump to.
    */
   ...
   /**
    * Can be used to store the actual <tt>Label</tt>
    * instance referenced by <tt>labelName</tt>.
    */
   private Label label;
