...
public class ASGVisitor extends Visitor
{
   ...
   /**
    * @see de.uni_paderborn.lib.util.Visitor#visit(java.lang.Object)
    */
   @Override
   public Object visit(Object node)
   {
      return visit((FElement) node);
   }
    ...
    * Visits an element.
    * 
    * @param fElement The element to be visited.
    */
   ...
   {
      return visit((FElement) node, arguments);
   }
    ...
    */
   public Object visit(FElement fElement, Object... arguments)
   {
      return super.visit(fElement, arguments);
   }
