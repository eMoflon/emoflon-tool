...
{
   /**
    * Get the firstFromDiagrams attribute of the FDiagramItem object
    *
    * @return   The firstFromDiagrams value
    */
   @Property(name=FElement.DIAGRAMS_PROPERTY)
   public abstract FDiagram getFirstFromDiagrams();
}
