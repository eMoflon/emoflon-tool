...
/**
 * This class represents an object diagram. For the moment it is only a subclass of UMLDiagram
 * for better structuration.
 *
 * @author    $Author$
...
public class UMLObjectDiagram extends UMLDiagram
{
    ...
    * @param persistent
    */
   protected UMLObjectDiagram (FProject project, boolean persistent)
   {
