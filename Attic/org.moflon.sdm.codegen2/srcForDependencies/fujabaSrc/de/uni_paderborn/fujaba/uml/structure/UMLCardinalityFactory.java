 ...
 */
class UMLCardinalityFactory extends UMLFlyweightFactory<UMLCardinality>
{

   public UMLCardinalityFactory(UMLProject project)
   {
      super(project);
   }
    ...
    */
   @Override
   public UMLCardinality getFromProducts(String key, boolean persistent)
   {
      if (key == null)
      {
         return null;
      ...
      {
         UMLCardinality flyweight = new UMLCardinality(getProject(), persistent, key);
