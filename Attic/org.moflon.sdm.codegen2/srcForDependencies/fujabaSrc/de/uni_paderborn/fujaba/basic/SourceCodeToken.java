...
public class SourceCodeToken extends TemplateToken
{
    ...
    */
   public SourceCodeToken (String code)
   {
      this.setCode (code);
   }
   ...
   {
      if ( (this.code == null) ||  (this.code != null && !this.code.equals (code)))
      {
         this.code = code;
      }
...
/*
 * $Log$
 * Revision 1.10  2006/04/06 12:04:34  cschneid
 * added missing @Override everywhere
 *
 * Revision 1.9  2004/10/20 17:49:28  schneider
