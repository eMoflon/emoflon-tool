...
public class CollabStatOperation extends ObjectOperation implements MutatingOperation
{
    ...
    * <pre>
    *           0..1     element     0..1
    * CollabStatOperation ------------------------> FElement
    *           collabStatOperation               element
    * </pre>
    */
   ...
   @Property( name = PROPERTY_ELEMENT )
   public CollabStatOperation withElement (FElement value)
   {
      setElement (value);
      return this;
   }
