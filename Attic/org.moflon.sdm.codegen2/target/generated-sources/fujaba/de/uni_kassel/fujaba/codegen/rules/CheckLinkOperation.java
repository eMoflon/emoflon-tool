...
public class CheckLinkOperation extends LinkOperation implements CheckOperation
{
   ...
   public LinkOperation getReverseOperation ()
   {
      ...
      CheckLinkOperation reverse = null;
            ...
            try
            {
               ...
               while ( !(fujaba__Success) && fujaba__IterLinkToReverse.hasNext () )
               {
                  try
                  {
                     ...
                     reverse = (CheckLinkOperation) _TmpObject;
    ...
    * <pre>
    *           0..1     supersedes     0..1
    * CheckLinkOperation ------------------------- SearchOperation
    *           supersedes               supersedes
    * </pre>
    */
   public static final String PROPERTY_SUPERSEDES = "supersedes";

   @Property( name = PROPERTY_SUPERSEDES, partner = SearchOperation.PROPERTY_SUPERSEDES, kind = ReferenceHandler.ReferenceKind.TO_ONE,
         adornment = ReferenceHandler.Adornment.NONE)
   private SearchOperation supersedes;

   @Property( name = PROPERTY_SUPERSEDES )
   public boolean setSupersedes (SearchOperation value)
   {
      ...
      if (this.supersedes != value)
      {
         ...
         SearchOperation oldValue = this.supersedes;
         CheckLinkOperation source = this;
   ...
   @Property( name = PROPERTY_SUPERSEDES )
   public CheckLinkOperation withSupersedes (SearchOperation value)
   {
      setSupersedes (value);
      return this;
   }
