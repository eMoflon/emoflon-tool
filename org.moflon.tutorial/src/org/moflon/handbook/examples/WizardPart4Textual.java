...
public class WizardPart4Textual extends AbstractExampleWizard
{
   ...
   protected Collection<ProjectDescriptor> getProjectDescriptors()
   {
      return Arrays.asList(//
            new ProjectDescriptor(BUNDLE_ID, ARCHIVE_OF_GENERATED_CODE, PROJECT_NAME_OF_GENERATED_CODE),//
            new ProjectDescriptor(BUNDLE_ID, ARCHIVE_OF_METAMODEL, PROJECT_NAME_OF_METAMODEL),//
            new ProjectDescriptor(BUNDLE_ID, ARCHIVE_OF_GUI, PROJECT_NAME_OF_GUI));
   }
