...
public class GenModelBuilder {
   ...
   public static final URI createArchiveURI(final URI archiveFileURI, String pathName) {
	   pathName = pathName.startsWith(SEGMENT_SEPARATOR) ? pathName.substring(1) : pathName;
	   final URI result = createArchiveURI(archiveFileURI);
	   return result.appendSegments(pathName.split(SEGMENT_SEPARATOR));
   }
}
