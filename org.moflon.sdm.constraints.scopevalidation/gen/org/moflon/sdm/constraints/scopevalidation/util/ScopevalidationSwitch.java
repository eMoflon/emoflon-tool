...
public class ScopevalidationSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case ScopevalidationPackage.ATTRIBUTE_CONSTRAINT_BLACK_PATTERN_INVOCATION_BUILDER: {
			...
			T result = caseAttributeConstraintBlackPatternInvocationBuilder(
		...
		case ScopevalidationPackage.ATTRIBUTE_CONSTRAINT_GREEN_PATTERN_INVOCATION_BUILDER: {
			...
			T result = caseAttributeConstraintGreenPatternInvocationBuilder(
					attributeConstraintGreenPatternInvocationBuilder);
			if (result == null)
				result = caseAttributeConstraintBlackPatternInvocationBuilder(
						attributeConstraintGreenPatternInvocationBuilder);
			if (result == null)
	 ...
	 * @generated
	 */
	public T caseAttributeConstraintBlackPatternInvocationBuilder(
	 ...
	 * @generated
	 */
	public T caseAttributeConstraintGreenPatternInvocationBuilder(
