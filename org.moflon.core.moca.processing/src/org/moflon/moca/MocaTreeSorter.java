...
public class MocaTreeSorter
{
   ...
   /**
    * Applies indices in the given MocaTree node.
    * Indices will also be applied during MocaTree->CommonTree transformation, use this 
    * method to explicitly sort the MocaTree.
    * @param node
    */
   ...
   /**
    * Applies indices in the given MocaTree.
    * Indices will also be applied during MocaTree->CommonTree transformation, use this 
    * method to explicitly sort the MocaTree.
    * @param node
    */
   ...
   /**
    * Applies indices in the given MocaTree file.
    * Indices will also be applied during MocaTree->CommonTree transformation, use this 
    * method to explicitly sort the MocaTree.
    * @param node
    */
