...
public class ProjectDependencyAnalyzer implements ITask
{
   ...
   public ProjectDependencyAnalyzer(final AbstractVisitorBuilder builder, final IProject metamodelProject, final IProject moflonProject,
   ...
   public static final void analyzeDependencies(final MultiStatus status, final TreeSet<IProject> projectReferences, final Resource resource)
   {
   ...
   {
      final MultiStatus status = new MultiStatus(WorkspaceHelper.getPluginId(getClass()), 0, "Project dependency analysis failed", null);
