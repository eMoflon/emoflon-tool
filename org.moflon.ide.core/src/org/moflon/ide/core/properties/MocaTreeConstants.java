...
/**
 * Constants for nodes in the Moca tree exported from EA
 *
 * @author Roland Kluge - Initial implementation
 */
public interface MocaTreeConstants
{
   String MOCA_TREE_ATTRIBUTE_INTEGRATION_PROJECT = "TGG";
   String MOCA_TREE_ATTRIBUTE_REPOSITORY_PROJECT = "EPackage";
