...
public class AttributeVariableConstraintsTypeModule implements TypeModule {
	...
	public AttributeVariableConstraintsTypeModule(List<AttributeConstraintLibrary> libraries) {
	...
	public final ConstraintType getConstraintType(AttributeVariableConstraint constraint) {
		//
