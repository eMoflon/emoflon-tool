...
public abstract class PatternMatcherGenerator extends PatternMatcherImpl {
	 ...
	 *                            if true, the search plan shall return all matches,
	 *                            if false the search plan shall return any match
	...
	public ValidationReport generateSearchPlan(final Pattern pattern, final Adornment adornment,
		...
		try {
			...
			LogUtils.debug(logger, "Symbolic parameters: %s",
					PatternUtils.describeSymbolicParameters(pattern, adornment));
	 ...
	 * @param searchPlan
	 *                            the search plan generated from the
	 *                            {@link CompilerPatternBody} and the
	 *                            {@link Adornment}
