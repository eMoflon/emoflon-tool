...
public class RuntimeConsistencyCheck extends SynchronizationHelper{

   public RuntimeConsistencyCheck()
   {
	...
	public static void main(String[] args) throws IOException {
        ...
        RuntimeConsistencyCheck helper = new RuntimeConsistencyCheck();
