...
/**
 * @author    joerg This interface is needed to enable types having an ID. More general all
 *      interfaces, which do not extend class BasicIncrement need this interface to access
 *      the ID of the actual object.
...
/*
 * $Log$
 * Revision 1.2  2004/10/20 17:49:29  schneider
