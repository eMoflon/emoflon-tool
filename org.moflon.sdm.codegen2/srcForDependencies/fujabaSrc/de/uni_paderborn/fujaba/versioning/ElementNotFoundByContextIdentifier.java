...
public class ElementNotFoundByContextIdentifier extends Exception
{
   ...
   public ElementNotFoundByContextIdentifier (String message, String identifier)
   {
      super (message);
      this.identifier = identifier;
   }
   
   public ElementNotFoundByContextIdentifier (String message, String identifier, Throwable cause)
   {
      super (message, cause);
      this.identifier = identifier;
   }
