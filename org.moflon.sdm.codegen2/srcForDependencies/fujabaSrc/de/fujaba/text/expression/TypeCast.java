 ...
 */
public class TypeCast extends TextNode
{
   /**
    * 
    * @param diagramItem
    ...
    * @param expr
    */
   public TypeCast(FParsedElement parsedElement, TypeExpression typeExpr, TextNode expr)
   {
      super(parsedElement);
