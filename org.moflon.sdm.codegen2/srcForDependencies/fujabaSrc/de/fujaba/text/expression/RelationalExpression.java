 ...
 */
public class RelationalExpression extends BooleanOperation
{
   /**
    * 
    * @param parsedElement
    ...
    * @param op2
    */
   public RelationalExpression(FParsedElement parsedElement, TextNode op1, Operator operator, TextNode op2)
   {
      super(parsedElement);
      setFirstOperand(op1);

      OperatorOperandPair pair = new OperatorOperandPair(parsedElement, operator, op2);
      addToOperatorOperandPairs(pair);
   }
