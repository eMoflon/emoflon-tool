...
public class BooleanLiteral extends Literal
{
    ...
    * @param image
    */
   public BooleanLiteral(FParsedElement parsedElement, boolean value, String image)
   {
      super(parsedElement, LiteralType.BOOLEAN, image);
      setValue(value);

      FFactory<FBaseType> baseTypeFactory = getProject().getFromFactories(FBaseType.class);
      setType(baseTypeFactory.getFromProducts(FBaseType.BOOLEAN));
   }
   ...
   /**
    * Returns true if this literal has the value true.
    */
   ...
   /**
    * Returns true if this literal has the value false.
    */
