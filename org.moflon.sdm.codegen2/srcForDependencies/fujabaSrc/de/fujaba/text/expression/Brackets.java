 ...
 */
public class Brackets extends TextNode
{
   /**
    * 
    * @param diagramItem
    * @param content
    */
   public Brackets(FParsedElement parsedElement, TextNode content)
   {
      super(parsedElement);
    ...
    * <pre>
    *           0..1     content     0..1 
    * UMLTextNode ------------------------- Brackets
    *           content      
    * </pre>
    */
   private TextNode content;

   public boolean setContent(TextNode value)
   {
      boolean changed = false;

      if(this.content != value)
      {
         TextNode oldValue = this.content;
         this.content = value;
