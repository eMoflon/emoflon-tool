...
public class CharLiteral extends Literal
{
    ...
    * @param image
    */
   public CharLiteral(FParsedElement parsedElement, String image)
   {
      super(parsedElement, LiteralType.CHAR, image);
      ...
      setType(baseTypeFactory.getFromProducts(FBaseType.CHARACTER));
   }
