 ...
 */
public class Dereference extends TextNode
{
    ...
    * @param diagramItem
    */
   public Dereference(FParsedElement parsedElement)
   {
      super(parsedElement);
   }
    ...
    * <pre>
    *           0..1     element
    * UMLTextNode &lt;--------------------- Dereference
    *           element
    * </pre>
    */
   private TextNode element;

   public boolean setElement(TextNode value)
   {
      boolean changed = false;

      if(this.element != value)
      {
         TextNode oldValue = this.element;
         this.element = value;
   ...
   /**
    * <pre>
    *           0..1     childElement     0..1 
    * Dereference ------------------------- Dereference
    *           childElement      dereference
    * </pre>
    */
   private TextNode childElement;

   public boolean setChildElement(TextNode value)
   {
      boolean changed = false;

      if(this.childElement != value)
      {
         TextNode oldValue = this.childElement;
   ...
   public TextNode getChildElement()
   {
   ...
   public void removeYou()
   {
      ...
      {
         this.getElement().removeYou();
         this.setElement(null);
      }

      if(this.getChildElement() != null)
      {
         this.getChildElement().removeYou();
