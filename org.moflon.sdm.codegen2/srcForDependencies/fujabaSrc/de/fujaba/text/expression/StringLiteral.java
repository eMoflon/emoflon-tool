...
{
   public StringLiteral(FParsedElement parsedElement, String image)
   {
      super(parsedElement, LiteralType.STRING, image);
      ...
      setType(baseTypeFactory.getFromProducts(FBaseType.STRING));
   }
