 ...
 */
public class Throw extends TextNode
{
   /**
    * 
    * @param parsedElement
    * @param expr
    */
   public Throw(FParsedElement parsedElement, TextNode expr)
   {
      super(parsedElement);
      setExpression(expr);
   }
   ...
   /**
    * Set the expression of this throw statement.
    * Accepts only Identifier and NewExpression instances.
    */
   public boolean setExpression(TextNode value)
   {
      boolean changed = false;

      if(!(value instanceof Identifier) && !(value instanceof NewExpression))
         return false;
