 ...
 */
public class Operator extends TextNode
{
   public Operator(FParsedElement parsedElement, OperatorType type)
   {
      super(parsedElement);
    ...
    * 
    */
   private OperatorType operatorType = OperatorType.DEFAULT;
