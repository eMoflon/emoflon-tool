...
public class ColorConverter
{
   ...
   public static Color parseString (String value)
   {
      ...
      logger.error ("unable to parse String '" + value + "' into Color: using default Color.BLACK");
      return Color.BLACK;
   }
   ...
   public static String toString (Color color)
   {
      ...
      {
         return String.format ("#%2x%2x%2x", color.getRed(), color.getGreen(), color.getBlue()).replaceAll (" ", "0").toUpperCase();
      }
   }
}
...
/*
 * $Log$
 * Revision 1.4  2007/03/26 11:18:09  fklar
