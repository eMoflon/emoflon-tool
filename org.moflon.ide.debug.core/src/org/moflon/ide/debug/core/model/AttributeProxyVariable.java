...
public class AttributeProxyVariable extends MoflonDebugElement implements IVariable
{
   ...
   public AttributeProxyVariable(AttributeProxy value)
   {
      super(null);
      this.aproxy = value;
