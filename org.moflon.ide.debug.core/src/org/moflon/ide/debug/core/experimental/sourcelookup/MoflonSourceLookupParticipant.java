...
import org.moflon.ide.debug.core.model.phases.init.InitialStateStackFrame;

/**
 * The PDA source lookup participant knows how to translate a PDA stack frame into a source file name
 */
public class MoflonSourceLookupParticipant extends AbstractSourceLookupParticipant
{
   /*
    * (non-Javadoc)
    * 
   ...
   {
      if (object instanceof InitialStateStackFrame)
      {
         // return ((TestStackFrame) object).getSourceName();
         return null;
      }
      return null;
   }
