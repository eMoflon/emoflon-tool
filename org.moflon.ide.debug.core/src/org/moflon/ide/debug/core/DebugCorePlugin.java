...
public class DebugCorePlugin extends Plugin
{
   ...
   /**
    * Unique identifier for the PDA debug model (value <code>pda.debugModel</code>).
    */
   public static final String ID_MOFLON_DEBUG_MODEL = "org.moflon.ide.debug.core.debugModel";

   /**
    * Name of the string substitution variable that resolves to the location of a local Perl executable (value
    * <code>perlExecutable</code>).
    */
   public static final String VARIALBE_PERL_EXECUTABLE = "perlExecutable";

   /**
    * Launch configuration attribute key. Value is a path to a perl program. The path is a string representing a full
    * path to a perl program in the workspace.
    */
   public static final String ATTR_PDA_PROGRAM = ID_MOFLON_DEBUG_MODEL + ".ATTR_PDA_PROGRAM";

   /**
    * Identifier for the PDA launch configuration type (value <code>pda.launchType</code>)
    */
   ...
   public ResourceBundle getResourceBundle()
   {
      try
      {
         if (resourceBundle == null)
            resourceBundle = ResourceBundle.getBundle("org.moflon.ide.debug.core.DebugCorePluginResources");
