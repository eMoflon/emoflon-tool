...
public class EMoflonStandardWorkspaces {
	...
	static {
		PATH_LOOKUP.put(TEST_WORKSPACE_TRANSFORMATION_ZOO_0_NAME,
				Arrays.asList("/resources/psf/tests/TestSuiteZoo0.psf"));
		PATH_LOOKUP.put(TEST_WORKSPACE_TRANSFORMATION_ZOO_1_NAME,
				Arrays.asList("/resources/psf/tests/TestSuiteZoo1.psf"));
		...
		PATH_LOOKUP.put(OLD_DEVELOPER_WORKSPACE_NAME,
				Arrays.asList("/resources/psf/development/OldDeveloperWorkspace.psf"));
		PATH_LOOKUP.put(OLD_DEVELOPER_WORKSPACE_TGG_NAME,
				Arrays.asList("/resources/psf/development/OldDeveloperWorkspace_TGG.psf"));
		...
		PATH_LOOKUP.put(MODULE_ALL_INCL_MOSL, Arrays.asList("/resources/psf/development/All_Modules_incl_MOSL.psf"));
		...
		PATH_LOOKUP.put(HANDBOOK_EXAMPLE_FINAL,
				Arrays.asList("/resources/psf/examples/HandbookExample_FinalSolution.psf"));
		PATH_LOOKUP.put(HANDBOOK_EXAMPLE_GUI,
				Arrays.asList("/resources/psf/examples/HandbookExample_LeitnersBoxGui.psf"));
		PATH_LOOKUP.put(HANDBOOK_EXAMPLE_PART3_START,
				Arrays.asList("/resources/psf/examples/HandbookExample_Part3_Start.psf"));
		PATH_LOOKUP.put(HANDBOOK_EXAMPLE_PART3_FINAL,
				Arrays.asList("/resources/psf/examples/HandbookExample_Part3_Final.psf"));
		PATH_LOOKUP.put(HANDBOOK_EXAMPLE_PART4_START,
				Arrays.asList("/resources/psf/examples/HandbookExample_Part4_FreshStart.psf"));
	}
