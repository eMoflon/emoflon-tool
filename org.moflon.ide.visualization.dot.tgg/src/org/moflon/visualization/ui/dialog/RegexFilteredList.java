 ...
 * @since 2.0
 */
public class RegexFilteredList extends Composite {
	/**
	...
	private class DefaultFilterMatcher implements FilterMatcher {
		...
		public void setFilter(String pattern) {
			fMatcher = new RegexMatcher(pattern);
		}
	 ...
	 */
	public RegexFilteredList(Composite parent, int style,
		...
		fSorter = new QuickSorter(new LabelComparator(ignoreCase));
	...
	private int filter() {
		...
		fFilterMatcher.setFilter(fFilter.trim());
		int k = 0;
