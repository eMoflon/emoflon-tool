 ...
 *     Lars Fritsche - introducing regex expressions to filter lists
 *******************************************************************************/
 ...
 * @since 2.0
 */
public abstract class AbstractElementDialog extends SelectionStatusDialog {
    ...
    protected RegexFilteredList fFilteredList;
     ...
     */
    protected AbstractElementDialog(Shell parent,
     ...
     */
    protected RegexFilteredList createFilteredList(Composite parent) {
        int flags = SWT.BORDER | SWT.V_SCROLL | SWT.H_SCROLL
                | (fIsMultipleSelection ? SWT.MULTI : SWT.SINGLE);

        RegexFilteredList list = new RegexFilteredList(parent, flags, fRenderer,
