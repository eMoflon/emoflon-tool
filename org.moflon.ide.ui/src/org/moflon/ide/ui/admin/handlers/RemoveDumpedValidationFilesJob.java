   ...
   public void run(IProgressMonitor monitor) throws CoreException
   {
      modelFolder.accept(new IResourceVisitor() {
         ...
         public boolean visit(IResource resource) throws CoreException
         {
            ...
            final List<String> extensions = Arrays.asList("red", "green", "binding", "bindingAndBlack", "black", "expression", "cf", "dfs", "sdm");
            if (resource instanceof IFile && extensions.stream().anyMatch(extension -> trimmedResourceName.endsWith(extension)))
            {
