package org.moflon.ide.visualization.dot.tgg.runtimepatterns.org.moflon.tie;
...
public class RuntimepatternsTrafo extends SynchronizationHelper{

   public RuntimepatternsTrafo()
   {
	...
	public static void main(String[] args) throws IOException {
        ...
        RuntimepatternsTrafo helper = new RuntimepatternsTrafo();
		helper.performForward("instances/fwd.src.xmi");
		
		// Backward Transformation
		helper = new RuntimepatternsTrafo();
