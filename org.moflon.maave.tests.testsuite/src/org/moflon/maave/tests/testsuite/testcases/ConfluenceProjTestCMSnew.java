...
public class ConfluenceProjTestCMSnew {
  ...
  @Ignore
   @Test
   public void test_ModuleOffer_v1() {
      System.out.println("");
      System.out.println("-------------------------------------------------------------");
      System.out.println("Starting ConfluenceProjTestCMS/test_ModuleOffer_v1" );
      CmsNewPackage.eINSTANCE.getClass();
      EPackage pack=TestRunner.loadTestMM("org.moflon.maave.tests.lang.cmsNew", "CmsNew");
      EClass clsSemester=(EClass) pack.getEClassifier("ModuleOffer");


      SymbGTRule rule1=ModelHelper.getRule(clsSemester,"setExam_v1");
      SymbGTRule rule2=ModelHelper.getRule(clsSemester,"reset_v0");
      SymbGTRule rule3=ModelHelper.getRule(clsSemester,"updateExam_v1");
      SymbGTRule rule4=ModelHelper.getRule(clsSemester,"updateLecture_v1");
      SymbGTRule rule5=ModelHelper.getRule(clsSemester,"closeModuleOffer_v0");
      SymbGTRule rule6=ModelHelper.getRule(clsSemester,"setLecture_v1");
      ConfigurableMorphismClassFactory morClassFac =MatchingUtilsFactory.eINSTANCE.createConfigurableMorphismClassFactory();
...
//      gts.getRules().add(ModelHelper.getRule(clsSemester,"closeSem_v0"));
      ...
      EClass clsThesis=(EClass) pack.getEClassifier("Thesis");
      gts.getRules().add(ModelHelper.getRule(clsThesis,"enterGrade_v0"));
...
//      gts.getRules().add(ModelHelper.getRule(clsSemester,"closeSem_v0"));
      ...
      EClass clsModuleOffer=(EClass) pack.getEClassifier("ModuleOffer");
      gts.getRules().add(ModelHelper.getRule(clsModuleOffer,"setExam_v1"));
      gts.getRules().add(ModelHelper.getRule(clsModuleOffer,"reset_v0"));
      gts.getRules().add(ModelHelper.getRule(clsModuleOffer,"updateExam_v1"));
      gts.getRules().add(ModelHelper.getRule(clsModuleOffer,"updateLecture_v1"));
      gts.getRules().add(ModelHelper.getRule(clsModuleOffer,"closeModuleOffer_v0"));
      gts.getRules().add(ModelHelper.getRule(clsModuleOffer,"setLecture_v1"));
