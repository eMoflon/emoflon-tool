...
public class DeltaTrafo extends SynchronizationHelper{
   ...
   public DeltaTrafo()
   {
	...
	public static void main(String[] args) throws IOException {
        ...
        DeltaTrafo helper = new DeltaTrafo();
//		helper.performForward("instances/fwd.src.xmi");
//		
//		// Backward Transformation
//		helper = new DeltaTrafo();
		helper.performBackward("instances/Delta.delta.xmi");
	}
