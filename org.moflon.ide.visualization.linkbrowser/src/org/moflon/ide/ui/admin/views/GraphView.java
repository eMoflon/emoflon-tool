...
public class GraphView extends ViewPart implements IZoomableWorkbenchPart
{
   ...
   private void addLayoutOptions(IMenuManager menu)
   {
      ...
      menu.add(new Action("Fixed Spring Layout", IAction.AS_RADIO_BUTTON) {
         public void run()
         {
      ...
      menu.add(new Action("Directed Graph Layout", IAction.AS_RADIO_BUTTON) {
         public void run()
         {
            viewer.setLayoutAlgorithm(new DirectedGraphLayoutAlgorithm(), true);
         }
      });

      menu.add(new Action("Sugiyama Layout", IAction.AS_RADIO_BUTTON) {
         public void run()
         {
            viewer.setLayoutAlgorithm(new SugiyamaLayoutAlgorithm(), true);
         }
      });
   }
