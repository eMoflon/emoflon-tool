...
public class MenuListener implements MenuDetectListener
{
   ...
   {
      if (root instanceof DebugCorrespondenceModel)
      {
         DebugCorrespondenceModel dcm = (DebugCorrespondenceModel) root;
         result.addAll(dcm.getCorrespondences());
      } else if (root instanceof DebugCorrespondence)
      {
         DebugCorrespondence dc = (DebugCorrespondence) root;
         result.add(dc.getSource());
         result.add(dc.getTarget());
      } else if (root instanceof DebugSynchronizationProtocol)
      {
         DebugSynchronizationProtocol dsp = (DebugSynchronizationProtocol) root;
         result.addAll(dsp.getMatches());
      } else if (root instanceof TripleMatch)
      {
         TripleMatch tm = (TripleMatch) root;
         result.addAll(tm.getCorrespondenceElements());
      } else if (root instanceof DebugEObjectProxy)
      {
         DebugEObjectProxy dep = (DebugEObjectProxy) root;
         result.addAll(dep.getChildren());
         result.addAll(dep.getReferenceChildren());
