 ...
 */
public class TransportPanel extends JPanel implements TreeModelChangedListener {
	...
	public TransportPanel() {
		super();
		myTransportTree = new JFixedWidthTree(null);
	...
	/**
	 * Define the TreeManager to use in this TransportPanel. This selects the
	 * underlying TreeModel, too.
	 * 
	 * @param aTreeManager
	 *            the TreeManager to use.
	 */
	public void setTreeManager(TreeManager aTreeManager) {
		myTreeSynthesizer = aTreeManager.createSortingTreeSynthesizer();
		myTreeSynthesizer.setRootNode(aTreeManager.getModel().getRootNode());

		getTransportTree().setModel(
				new DefaultTreeModel(myTreeSynthesizer.getVisibleTree()));
		myTreeManager = aTreeManager;
		myTreeSynthesizer.addTreeModelChangedListener(this);
	}

	/**
	 * Gets the used TreeManager of this <code>TransportPanel</code>
	 * 
	 * @return this TransportPanel's TreeManager
	 */
